# Knowledge Base: Katalog Produk & Spesifikasi IntelliTrac 2026

## 1. Lineup Produk GPS Tracker & Dashcam Utama
...
- **Fungsi Utama**: Solusi pengawasan maksimal untuk armada komersial besar, truk kargo, bus, atau truk tambang.
- **Fitur Unggulan**:
...
- **Kategori**: Pelacak GPS 4G LTE Ringkas & Efisien untuk manajemen armada dasar.
- **Peruntukan**: Mobil penumpang, mobil operasional kantor, sepeda motor, van ekspedisi.
- **Fitur Utama**:
...
## 2. Sensor & Aksesori Tambahan (Sensors & Accessories)
...
3. **Rotation Sensor (Sensor Rotasi Drum Mixer)**:
   - Memantau arah dan kecepatan putaran drum beton pada truk mixer semen (Idle / Mixing / Unload).
4. **Auxiliary / PTO Indicator (Power Take-Off)**:
   - Memantau penggunaan fungsi khusus kendaraan/alat berat (misal: dumper truk hidrolik, lengan excavator, blade bulldozer, forklift, seatbelt).
5. **iButton (ID Reader)**:
   - Sistem identifikasi pengemudi berbasis kunci iButton untuk mencatat siapa yang mengemudikan kendaraan secara akurat.
